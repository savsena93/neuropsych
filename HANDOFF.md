...
- Stimulus caveat: the MoCA v8.1 naming items now use verified isolated crops in `assets/test-images/moca/`. The RQCST source assets remain composite sheets and must not be assigned directly to individual naming, unusual-view, or spatial-orientation items until item-specific crops are verified.
